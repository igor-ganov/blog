...
один тест. На SPA для администрирования контента это сыграло по-настоящему: молчаливые
обработчики catch были причиной того, почему целый класс продакшен-регрессий
