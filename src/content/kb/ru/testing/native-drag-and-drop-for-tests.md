...
1. Функцию, которой не могут управлять тесты, нельзя подтвердить рабочей в CI. Правило
   трёх прогонов (см. [нет повторов, нет флаков](/kb/testing/no-retries-no-flakes))
...
[событийных ожиданий](/kb/testing/event-driven-no-timeouts): тест не должен зависеть от
