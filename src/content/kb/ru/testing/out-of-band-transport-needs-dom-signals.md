...
гонку. С [4 параллельными воркерами](/principles/testing/parallel-workers-surface-races)
...
- Пустой раздел — это отдельное состояние. Если нужный раздел может быть пустым,
...
[Правило трёх прогонов под параллельными воркерами](/principles/testing/no-retries-no-flakes)
