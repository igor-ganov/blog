...
который пропускал HTML-блоки насквозь. Два факта превращают это из теоретического в
критическое. Первое: авторы и читатели сидят на разных уровнях привилегий —
пользователи с ролью редактора пишут контент блога, а главреды и админы рецензируют его
в той же панели превью. Второе: вскрываемая сессия дорого стоит, потому что токен
