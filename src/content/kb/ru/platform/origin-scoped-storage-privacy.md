...
пользователя. Граница — это правильное поведение по умолчанию.
...
Этот текст точен и вызывает доверие. Фича прекрасно работает без отслеживания межсайтовых
визитов, чего она и не была призвана делать.
