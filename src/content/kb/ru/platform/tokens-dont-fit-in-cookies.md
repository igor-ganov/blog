...
[Кросс-доменная аутентификация, переживающая блокировку сторонних cookie](/kb/platform/cross-origin-auth-survives-cookie-blocking)
...
[Переменные окружения времени сборки запекаются в артефакт](/kb/build-ci-deploy/build-time-env-is-baked) разбирает смежную
