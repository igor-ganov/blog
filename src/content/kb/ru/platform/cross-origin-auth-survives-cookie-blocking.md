...
Система авторизации проверяется в более жёстком, кросс-доменном режиме ещё в preview, до того как доберётся до продакшена, так что регрессия в пути Bearer всплывает во время ревью.
