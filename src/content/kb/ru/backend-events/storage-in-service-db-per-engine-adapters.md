...
Первые два варианта ломают гарантию атомарности. Третий нарушает абстракцию адаптера и
прибивает интерфейс к одному движку, так что переиспользовать его в парке с разными
движками уже не получится.
