...
В каждом обсуждении дизайна, где речь заходит про распределённые транзакции, обычно
всплывает вариант с сагой. Саги действительно решают задачу согласованности между
сервисами, так что идея звучит разумно, но она смешивает две проблемы, которые
...
Оба ставят паттерн не на своё место: один тратит силы на логику компенсации, которая
бессмысленна для реального режима сбоя, другой строит сагу на транспорте, который молча
