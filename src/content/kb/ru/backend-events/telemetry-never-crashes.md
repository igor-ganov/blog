...
- Сбой телеметрии — no-op, никогда не падение.
...
Все они позволяют слою наблюдаемости вредить тому, за чем он должен следить: уронить
приложение на временном сбое, раздуть стоимость и шум в трассах, разорвать трассу через
границу очереди или проглотить прикладную ошибку внутри кода телеметрии, что напрямую
