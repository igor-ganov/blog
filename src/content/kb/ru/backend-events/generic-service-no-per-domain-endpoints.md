...
Шаблон с отдельными эндпоинтами связывает инфраструктуру с каждым изменением домена.
Проталкивание доменной логики в сервис превращает инфраструктуру в сервис фич. А
нормализованное хранение выбрасывает гарантию одного запроса, затаскивая агрегацию обратно в
каждое чтение.
