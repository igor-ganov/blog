...
Оба варианта с двойной записью ломают гарантию доставки. Проглатывание ошибки вставки ломает
контракт обработки ошибок: законный no-op — только `code === 11000`, а всё остальное обязано
пробрасываться дальше.
