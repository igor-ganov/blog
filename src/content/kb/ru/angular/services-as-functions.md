...
Эти схемы дают одни и те же симптомы: вы поднимаете `TestBed` ради логики, у которой нет
зависимости от Angular, состояние меняется откуда угодно без прослеживаемого пути записи, а
доменные правила застревают внутри слоя сервисов, где их больше никто не может
переиспользовать.
