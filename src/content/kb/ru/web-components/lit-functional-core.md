...
ARIA и обработкой клавиатуры — и всё в одном файле. Такую логику трудно протестировать без
настоящего браузера, и её не переиспользуешь за пределами этого элемента.
