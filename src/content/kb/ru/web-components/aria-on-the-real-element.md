...
останется своим собственным неподписанным интерактивным узлом. На выходе два узла: один с
меткой и без роли, другой с ролью и без метки.
...
так что попадание их на правильный элемент окупается дважды.
