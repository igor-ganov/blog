...
- [bun-by-default](/principles/tooling-runtime/bun-by-default) — `bun` — рантайм по умолчанию; он тоже запускает `.ts` нативно и предпочтительнее для большинства скриптов.
