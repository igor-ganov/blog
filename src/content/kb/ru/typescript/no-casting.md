...
Правило такое: никаких `as` и никаких `!`, без исключений для тестов или «только в этот
раз».
...
декларативные компоненты выросли из одной и той же последовательной позиции.
