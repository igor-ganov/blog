...
[organizzata in base a dove viene usata](/kb/functional-architecture/one-function-per-file-folder-by-usage),
...
[switch e mappe di strategie, non catene sparpagliate di `if`/ternari](/kb/functional-architecture/no-branching-switch-and-strategies).
...
[currying e alle closure](/kb/functional-architecture/currying-closures-higher-order)
...
compito del confine: [validare al bordo](/kb/typescript/validate-at-the-boundary), e farlo
[facendo il parsing, non il controllo](/kb/functional-architecture/parse-dont-validate). Un
...
[modellati nel tipo e mai inghiottiti in silenzio](/kb/error-handling/never-swallow-errors),
...
[dipende da cosa stai usando davvero](/kb/functional-architecture/errors-as-values-with-effect),
...
[imposto da regole di lint](/kb/functional-architecture/lint-enforces-architecture) che
