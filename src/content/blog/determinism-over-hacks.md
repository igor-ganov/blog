...
[drive real drag events](/kb/testing/native-drag-and-drop-for-tests)) instead of a sprinkle
of waits.
...
through the [non-negotiables](/essays/the-non-negotiables) and the
[functional core](/essays/functional-core-imperative-shell), and it shows up most sharply
