...
lede: "Письменная запись того, как я создаю софт: практики и соглашения за моим кодом, архитектурой, тестами, инструментами и дизайном. Она здесь, чтобы её использовали и оспаривали."
